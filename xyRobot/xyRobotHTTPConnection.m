...
@implementation xyRobotHTTPConnection
@synthesize delegate;
...
- (void) processEndOfPartWithHeader:(MultipartMessageHeader*) header
{
    ...
    ///SEND MESSAGE TO LOADED FILE
    MultipartMessageHeaderField* disposition = [header.fields objectForKey:@"Content-Disposition"];
    NSString* filename = [[disposition.params objectForKey:@"filename"] lastPathComponent];
    NSString* uploadDirPath = [[config documentRoot] stringByAppendingPathComponent:@"upload"];
    NSString* filePath = [uploadDirPath stringByAppendingPathComponent: filename];
    NSDictionary* userInfo=[NSDictionary dictionaryWithObjectsAndKeys:[NSString stringWithFormat:@"%@",filename ],@"name",[NSString stringWithFormat:@"%@",filePath ],@"path", nil];
    NSNotificationCenter* defaultCenter=[NSNotificationCenter defaultCenter];

    [defaultCenter postNotification:[NSNotification notificationWithName:@"upload" object:nil userInfo:userInfo]];
